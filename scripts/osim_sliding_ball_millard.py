"""OpenSim forward-dynamics sliding-ball with Millard2012EquilibriumMuscle.

Same 1-DOF model as osim_sliding_ball.py but uses Millard muscle instead of DGF.
"""
...
def osim_sliding_ball_millard(muscle_length, ball_mass, sigma0, muscle_radius,
    ...
    """Build OpenSim 1-DOF model with Millard2012EquilibriumMuscle.
    ...
    Args:
        ...
        dt: Report interval [s].

    Returns:
        dict with 'times', 'positions', 'forces', 'norm_fiber_lengths', etc.
    """
    ...
    model = osim.Model()
    model.setName("sliding_ball_millard")
    ...
    # Millard2012EquilibriumMuscle instead of DeGrooteFregly2016Muscle
    ...
    muscle.set_tendon_slack_length(0.001)  # near-rigid tendon
    ...
    model.printToXML("output/sliding_ball_millard.osim")
    ...
    print(f"OpenSim Millard forward sim: F_max={max_isometric_force:.1f}N, "
    ...
    print(f"Done: {len(times)} points, final y={positions[-1]:.4f}, "
